...
The raw CSV files are public EIA observations downloaded from FRED. The normalized file used by the application is `data/processed/market_prices.csv`. Rebuild it with:
